...
public enum Material {
    ...
    OAK_LEAVES("leaves", 7, 4, 12, 1, 0),
    WEED("Weed", 8, 7, 13, 24, 1, false, true),
    ROSE("Rose", 63, 12, 15, 23, 1, false, true),
    DEAD_BUSH("Deadbush", 10, 7, 12, 14, 3, false, true),
    BIRCH_LOG("Birch_log", 64, new Vector2i(5, 8), new Vector2i(5, 8), new Vector2i(5, 8), new Vector2i(5, 8), new Vector2i(10, 7), new Vector2i(10, 7), 8, 7),
    ...
    MAIL_TELEPORTATION("Dropper", 57, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(12, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    DNS_TELEPORTATION("Dispenser", 62, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(11, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    WEB_TELEPORTATION("Melon_block", 65, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(13, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    HUB_TELEPORTATION("Pumpkin", 66, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(14, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    RED_LED("Redstone_block", 67, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(9, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    GREEN_LED("emerald_block", 68, new Vector2i(6,15), new Vector2i(6, 15), new Vector2i(10, 6), new Vector2i(6, 15), new Vector2i(6, 15), new Vector2i(6, 15), 1, 5, true, false),
    BARRIER("Barrier", 69, 5, 4, 3, 0, true, false ),
